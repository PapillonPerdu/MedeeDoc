...
.. image:: _static/images/menu_ref.png
   :class: floating-left

**Cliquer une fois** sur un **nœud** fait apparaître :

- un :ref:`menu local <Menu local>`;

.. image:: _static/images/menu_local.png
    :align: center

- une :ref:`notice de présentation <Notice>` du texte (dans le coin supérieur gauche du graphe) ;

.. image:: _static/images/noeuds_notice.png
    :align: center
    :width: 300px

- un :ref:`bandeau à gauche <Informations sur un nœud>` (ci-contre) donnant diverses informations sur le nœud.
...
.. figure:: _static/images/noeuds_voisinage.png
   :class: floating-right

**Cliquer deux fois** sur un nœud montre uniquement le voisinage complet du nœud, c’est-à-dire les nœuds directement liés à lui et leurs liens mutuels.
...
.. figure:: _static/images/noeuds_notice_zoom.png
   :class: floating-right
   :width: 500px
...
.. image:: _static/images/menu_ref_biblio.png
   :align: center
...
.. figure:: _static/images/menu_ref_recherche_nom.png
   :align: center

   Textes attribués à Campanus


.. figure:: _static/images/menu_ref_recherche_ville.png
   :align: center

   Éditions publiées dans la même ville que Campanus 1482


.. figure:: _static/images/menu_ref_recherche_langue_latin.png
   :align: center

   Textes dans la même langue que Campanus 1482


.. figure:: _static/images/menu_ref_recherche_langue_grec.png
   :align: center

   Textes dans la même langue que le Paris. 2346


.. figure:: _static/images/menu_ref_recherche_annee.png
   :align: center
...
.. figure:: _static/images/menu_barre_deselectionner.png
   :align: center
...
.. figure:: _static/images/menu_ref_urls_2346_Campanus.png
   :align: center
...
.. figure:: _static/images/menu_ref_cadre_complet.png
   :align: center

   Délimitation de la partie visible du graphe


.. figure:: _static/images/menu_ref_cadre_superieur.png
   :align: center

   Vue du graphe en prenant le Paris. 2346 comme bord supérieur


.. figure:: _static/images/menu_ref_cadre_gauche.png
   :align: center

   Vue du graphe en prenant le Paris. 2346 comme bord gauche


.. figure:: _static/images/menu_ref_cadre_droit.png
   :align: center

   Vue du graphe en prenant le Paris. 2346 comme bord droit


.. figure:: _static/images/menu_ref_cadre_angle_superieur_droit.png
   :align: center
...
.. figure:: _static/images/menu_ref_mots-clefs.png
   :align: center
...
.. figure:: _static/images/menu_ref_mots-clefs_select.png
   :align: center
...
.. figure:: _static/images/menu_ref_mot-clef_noeuds_selectionnes.png
   :align: center
...
.. figure:: _static/images/menu_ref_def_mot-clef.png
   :align: center
...
.. figure:: _static/images/menu_ref_mots-clefs_noeuds_selectionnes.png
   :align: center
...
.. figure:: _static/images/menu_ref_mots_clefs_noeuds_exclus.png
   :align: center
...
.. figure:: _static/images/menu_ref_mots_clefs_noeuds_combines.png
   :align: center
...
Réinitialiser
-------------
.. figure:: _static/images/menu_ref_mots_clefs_reinitialiser.png
   :align: center
...
.. figure:: _static/images/menu_ref_mots_clefs_manquants_but.png
   :align: center
...
Voisinages
----------
.. figure:: _static/images/menu_ref_voisinages.png
   :align: center

   Voisinages proposés d'un nœud

.. figure:: _static/images/voisinage_simple_Clavius.png
   :align: center

   Voisinage simple de Clavius 1574

.. figure:: _static/images/voisinage_simple_complet_Clavius.png
   :align: center

   Voisinage complet de Clavius 1574

.. figure:: _static/images/voisinage_buts_Clavius.png
   :align: center

   Voisinage en but de Clavius 1574


.. figure:: _static/images/voisinage_buts_complet_Clavius.png
   :align: center

   Voisinage en but complet de Clavius 1574


.. figure:: _static/images/voisinage_buts_etendu_Clavius.png
   :align: center

   Voisinage en but étendu de Clavius 1574 (partiel)


.. figure:: _static/images/voisinage_sources_Clavius.png
   :align: center

   Voisinage en source de Clavius 1574


.. figure:: _static/images/voisinage_sources_complet_Candalle.png
   :align: center

   Voisinage en source complet de Candalle 1566


.. figure:: _static/images/voisinage_sources_etendu_Clavius.png
   :align: center
...
.. figure:: _static/images/menu_ref_biblio.png
   :class: floating-left
