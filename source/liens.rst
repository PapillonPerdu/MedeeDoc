...
- une description du lien (source, type du lien, but) ;
- des textes s’y rapportant (“présentation de”, “cite”, “remarques sur”, “études sur”, etc.)


Bibliographie
-------------
A chaque lien est associé un ensemble de références distinguées suivant le type de leur lien au lien et leur position (en source ou en but).
...
↔: ouvre une fenêtre faisant apparaître toutes les références en but et en source du lien permettant de naviguer entre ces références;

rmqs : affiche des remarques de la référence sur le lien considéré.